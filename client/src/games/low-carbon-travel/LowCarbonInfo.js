...
const LowCarbonInfo = () => {
    const context = require.context("../../images/low-carbon-infographics", true, /\.jpg$/);
    const images = getArrayOfAllFolderChildren(context);
  
    return (
        <div className={classes.Container}>
            <h3 className={classes.CarouselTitle}>Low Carbon Travel</h3>
            ...
            <Link to="lowcarbon/intro"> <button className="Btn">I'm Ready!</button></Link>
      </div>
    )
  }
  
  export default LowCarbonInfo;